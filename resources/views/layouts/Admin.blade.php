<x-backend.layouts.master>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pt-4">
            ...
            <div class="col-md-12">
                <h2><strong class="text-center"> Last 12 Month Income & Expense With 50% Needs, 30% Wants, 20% Savings Rule </strong>
                </h2>
                @php
                    $currentYear = date('Y');
            ...
            <div class="col-md-3">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        @endforeach 
                        <tr class="bg-success">
                            <td colspan="3">Total Income: {{ $thisYearIncome->sum('totalIncameYear') }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
